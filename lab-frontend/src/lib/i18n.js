export const translations = {
  en: {
    ...
    // ── Step 0: Jurisdiction + Risk Appetite ──
    step0_title: "Where you operate",
    step0_sub:   "Determines which AI regulations apply to your system",
    f_registered_country:      "Where is your organisation registered?",
    f_registered_country_hint: "Your registration country determines your primary regulatory obligations. An Estonia-registered company is subject to EU AI Act regardless of where it serves.",
    f_served_countries:        "Which countries do you serve with this AI system?",
    f_served_countries_hint:   "Any country where your AI output affects people may create regulatory obligations — even without physical presence.",
    f_role: "What is your role with this AI system?",
    role_provider:      "Provider — we built or trained this AI system",
    role_deployer:      "Deployer — we use a ready-made AI from a third party",
    role_both:          "Both — we built it and use it ourselves",
    role_importer:      "Importer — we bring an AI system into the EU market",
    f_risk_tolerance:          "When this AI system makes a wrong decision, what does your organisation do?",
    f_risk_tolerance_hint:     "ISO 31000: Risk appetite is the amount and type of risk you are willing to accept. NIST AI RMF MAP 1.5 requires this to be documented before deployment.",
    rt_stop:     "Stop — halt system and manually review every affected case",
    rt_escalate: "Escalate — flag affected person for human review before any action",
    rt_sample:   "Sample — investigate proportion of errors, act if threshold exceeded",
    rt_monitor:  "Monitor — track performance trends, intervene if quality degrades",
    f_security_tolerance:      "If this AI system caused a data breach or security incident, what is your organisation's position?",
    f_security_tolerance_hint: "Security risk appetite often differs from operational risk appetite — typically stricter in finance, health, and critical infrastructure. (ISO 31000 / CISSP)",
    sec_zero:   "Zero tolerance — one incident triggers immediate shutdown and full independent audit",
    sec_low:    "Low — any incident triggers formal review, system paused pending investigation",
    sec_medium: "Medium — follow standard incident response process and report as required",
    sec_high:   "High — incidents expected in production, managed as they arise",
  ...
  tr: {
    ...
    // ── Step 0: Jurisdiksiyon + Risk İştahı ──
    step0_title: "Faaliyet gösterdiğiniz yerler",
    step0_sub:   "Sisteminize hangi AI düzenlemelerinin uygulandığını belirler",
    ...
    f_served_countries_hint:   "AI sisteminizin etkilediği her ülke düzenleyici yükümlülükler yaratabilir — fiziksel varlığınız olmasa bile.",
    ...
    f_risk_tolerance_hint:     "ISO 31000: Risk iştahı, kabul etmeye hazır olduğunuz risk miktarı ve türüdür. NIST AI RMF MAP 1.5 bunun dağıtımdan önce belgelenmesini gerektirir.",
    ...
    f_security_tolerance_hint: "Güvenlik risk iştahı genellikle operasyonel risk iştahından daha katıdır — finans, sağlık ve kritik altyapıda genellikle daha sıkıdır. (ISO 31000 / CISSP)",
